...
X = X.reshape(3 * n, L * L)
X = X + np.abs(np.random.normal(0, 0.60, X.shape))
...
for i in range(0, len(combinations)):
    ...
    plt.savefig(f"Lines_Noise_{i}_2.png", dpi=300)
...
plt.ylabel("Generalization error")
plt.show()
# plt.savefig(f"Lines_Noise_basic_2.png", dpi=300)
